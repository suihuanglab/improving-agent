...
from evidara_api.models.knowledge_graph import KnowledgeGraph  # noqa: E501
...
class Result(Model):
    ...
    def reasoner_id(self):
        ...
        Identifier string of the reasoner that provided this result (e.g., BigGIM, RTX)  # noqa: E501
