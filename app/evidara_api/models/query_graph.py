...
from evidara_api.models.q_edge import QEdge  # noqa: E501
from evidara_api.models.q_node import QNode  # noqa: E501
...
class QueryGraph(Model):
    ...
    def __init__(self, nodes=None, edges=None):  # noqa: E501
        ...
        """
        self.openapi_types = {"nodes": List[QNode], "edges": List[QEdge]}

        self.attribute_map = {"nodes": "nodes", "edges": "edges"}
