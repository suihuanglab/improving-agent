...
from evidara_api.models.edge import Edge  # noqa: E501
from evidara_api.models.node import Node  # noqa: E501
...
class KnowledgeGraph(Model):
    ...
    def __init__(self, nodes=None, edges=None):  # noqa: E501
        ...
        """
        self.openapi_types = {"nodes": List[Node], "edges": List[Edge]}
