...
from evidara_api.models.message_terms import MessageTerms  # noqa: E501
...
class Message(Model):
    ...
    def __init__(self, context=None, type=None, id=None, reasoner_id=None, tool_version=None, schema_version=None, datetime=None, n_results=None, message_code=None, code_description=None, original_question=None, restated_question=None, terms=None, query_options=None, query_graph=None, knowledge_graph=None):  # noqa: E501
    ...
    def reasoner_id(self):
        ...
        Identifier string of the KPs that provided this message (one of BigGIM, Robokop, etc.)  # noqa: E501
