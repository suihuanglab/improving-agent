...
from evidara_api.node_normalization import NodeNormalization
from evidara_api.test.test_config import RUN_REAL_API
from evidara_api.test.client_test_data.node_normalization_data import (
...
class TestNodeNormalization():
    @classmethod
    def setup_class(cls):
        cls.mock_requests_get_patch = patch('evidara_api.node_normalization.requests.get')
