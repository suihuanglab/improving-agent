...
class QNode(Model):
    ...
    @property
    def set_interpretation(self) -> str:
    ...
    def set_interpretation(self, set_interpretation: str):
    ...
    @property
    def constraints(self) -> List[AttributeConstraint]:
    ...
    @constraints.setter
    def constraints(self, constraints: List[AttributeConstraint]):
