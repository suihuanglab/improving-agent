...
from improving_agent.models.runner_parameters import RunnerParameters  # noqa: E501
...
class OperationLookupAndScore(Model):
    ...
    @property
    def runner_parameters(self) -> RunnerParameters:
    ...
    def runner_parameters(self, runner_parameters: RunnerParameters):
