...
class QEdge(Model):
    ...
    def knowledge_type(self, knowledge_type: str):
    ...
    @predicates.setter
    def predicates(self, predicates: List[str]):
    ...
    @property
    def attribute_constraints(self) -> List[AttributeConstraint]:
    ...
    def attribute_constraints(self, attribute_constraints: List[AttributeConstraint]):
    ...
    @property
    def qualifier_constraints(self) -> List[QualifierConstraint]:
    ...
    def qualifier_constraints(self, qualifier_constraints: List[QualifierConstraint]):
