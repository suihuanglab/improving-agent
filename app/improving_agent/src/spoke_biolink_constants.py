...
BIOLINK_SPOKE_NODE_MAPPINGS = {
    ...
    BIOLINK_ENTITY_BIOLOGICAL_PROCESS: (SPOKE_LABEL_BIOLOGICAL_PROCESS, "no-split"),
    BIOLINK_ENTITY_CELL: (SPOKE_LABEL_CELL_TYPE, "no-split"),
    BIOLINK_ENTITY_CELLULAR_COMPONENT: (SPOKE_LABEL_CELLULAR_COMPONENT, "no-split"),
    BIOLINK_ENTITY_CHEMICAL_SUBSTANCE: (SPOKE_LABEL_COMPOUND, "no-split"),
    BIOLINK_ENTITY_DISEASE: (SPOKE_LABEL_DISEASE, "no-split"),
    BIOLINK_ENTITY_GENE: (SPOKE_LABEL_GENE, "split"),
    BIOLINK_ENTITY_GROSS_ANATOMICAL_STRUCTURE: (SPOKE_LABEL_ANATOMY, "no-split"),
    BIOLINK_ENTITY_MOLECULAR_ACTIVITY: (SPOKE_LABEL_MOLECULAR_FUNCTION, "no-split"),
    BIOLINK_ENTITY_PATHWAY: (SPOKE_LABEL_PATHWAY, "no-split"),
    BIOLINK_ENTITY_PHENOTYPIC_FEATURE: (SPOKE_LABEL_SYMPTOM, "split"),
    BIOLINK_ENTITY_PROTEIN: (SPOKE_LABEL_PROTEIN, "split"),

    # for "any node type"
    BIOLINK_ENTITY_NAMED_THING: (False, "no-split"),
...
BIOLINK_SPOKE_EDGE_MAPPINGS = {
    ...
    BIOLINK_ASSOCIATION_NEGATIVELY_REGULATES_ENTITY_TO_ENTITY: SPOKE_EDGE_TYPE_DOWNREGULATES_OGdG,
    BIOLINK_ASSOCIATION_PARTICIPATES_IN: SPOKE_EDGE_TYPE_PARTICIPATES_GpMF,
    BIOLINK_ASSOCIATION_PART_OF: SPOKE_EDGE_TYPE_PARTOF_ApA,
    BIOLINK_ASSOCIATION_POSITIVELY_REGULATES_ENTITY_TO_ENTITY: SPOKE_EDGE_TYPE_UPREGULATES_OGuG,
